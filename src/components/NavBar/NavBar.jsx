...
<IoCartOutline className="basket" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"/>
...
<h1>ALL ITEMS </h1>
   ...
   <div className="row g-0 ">
          ...
          <button id="cash" className="cash" onClick={(e)=>checkOut({allItems})} >ADD ORDER</button> <br/><br/>
          <button className= {`${isActive ?  "dblock cash" : "dnone" }`} onClick={(e)=>createOrder()} > CHECKOUT</button>
